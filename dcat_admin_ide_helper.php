...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection exchange
     ...
     * @method Grid\Column|Collection exchange(string $label = null)
     ...
     * @property Show\Field|Collection exchange
     ...
     * @method Show\Field|Collection exchange(string $label = null)
